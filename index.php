...
<html lang="en">
	<head>
	    ...
	    <title>Maseno All Products Plartform</title>
		...
		<script src="https://kit.fontawesome.com/d90d9968e2.js" crossorigin="anonymous"></script>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Top Deals</h4>
						</div>
					</div>	
					<h6 class="text">Best deals and flash sales available.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free delivery order above KES. 200.00</h6>	
				</div>
			</div><!-- .col -->
