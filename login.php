...
<html lang="en">
	<head>
	    ...
	    <title>MASENO APP | SignIn | SignUp</title>
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">signIn</h4>
	<p class="">Hello there, Welcome to your account.</p>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Create a new account.</p>
...
<div class="form-group">
	...
	<div class="checkbox">
		...
		<label class="checkbox">
 Keep a record of all your purchases. Welcome...
		</label>
	</div>
</div>	
