        ...
        for (n = r.length; --n > -1; )
          (o = r[n]) === e ||
            ...
            (o._timeline !== e._timeline
              ...
              : u >= o._startTime &&
                o._startTime + o.totalDuration() / o._timeScale + h > u &&
      ...
      var h,
        ...
        H = function (t, e, i) {
          ...
          var s = "left" === e ? "Left" : "Top",
            r = Q(t, "margin" + s, i);
          return (
            t["offset" + s] - (Z(t, e, parseFloat(r), r.replace(y, "")) || 0)
          );
        },
        $ = function (t, e) {
          var i,
      ...
      var ve =
        ...
        be = function (t, e, i, s) {
          ...
          var r,
            ...
            b = w * M,
            P = we
              ? parseFloat(Q(t, xe, e, !1, "0 0 0").split(" ")[2]) ||
                v.zOrigin ||
                0
              : 0;
          for (
              ...
              for (
                ...
                (S = J[ce]),
                  ...
                  (i =
                    -1 !== P.indexOf("px")
                      ? parseFloat(P)
                      : Z(this.t, S, parseFloat(P), P.replace(y, "")) || 0),
                  (R =
                    i !== s[S]
                      ? 2 > ce
                        ? -s.ieOffsetX
          ...
          if (
            (p &&
              ((P = C.top
                ...
                : C.bottom
                ? "bottom"
                : parseFloat(Q(this.t, "top", null, !1))
                ? "bottom"
                : "top"),
              (T = Q(this.t, P, null, !1)),
              (S = parseFloat(T) || 0),
            ...
            (v = Math.cos(A)),
              ...
              (r = y),
              k.skewX &&
                ((A -= k.skewX * M), (v = Math.cos(A)), (y = Math.sin(A))),
              (e = -y),
              (n = v);
          else {
      ...
      me(
        "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D",
        {
          parser: function (t, e, i, s, n, a, o) {
            ...
            for (
              null != y.force3D && ((d.force3D = y.force3D), (f = !0)),
                p =
                  d.force3D ||
                  d.z ||
                  d.rotationX ||
